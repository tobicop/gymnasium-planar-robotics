...
# Goals were removed, "billiard" mode                    #
##########################################################

"""This is a significantly shortened version of ``BenchmarkPlanningEnv`` used for testing movement, dynamics, collisions and
the "billiard" mode. In this mode, movers follow straight trajectories and are repelled when reaching the walls. The environment
is a simple planning environment without goals, proper reward computation, observation etc.
